...
class PhilCanvas extends Canvas {
    ...
    public PhilCanvas(Diners controller) {
        ...
        imgs[0] = controller.getImage(controller.getCodeBase(), "thinking.gif");
        mt.addImage(imgs[0], 0);
        imgs[1] = controller.getImage(controller.getCodeBase(), "hungry.gif");
        mt.addImage(imgs[1], 1);
        imgs[2] = controller.getImage(controller.getCodeBase(), "gotright.gif");
        mt.addImage(imgs[2], 2);
        imgs[3] = controller.getImage(controller.getCodeBase(), "eating.gif");
        mt.addImage(imgs[3], 3);
        imgs[4] = controller.getImage(controller.getCodeBase(), "gotleft.gif");
